...
mkOption ::
    ...
    HoleOption InternalName (OnceT (T m)) (T m)
...
mkHoleSuggesteds ::
    ...
    [(Val (), HoleOption InternalName (OnceT (T m)) (T m))]
...
sugar ::
    ...
    OnceT (T m) (Annotated (Payload InternalName (OnceT (T m)) (T m) a) (Binder InternalName (OnceT (T m)) (T m)))
