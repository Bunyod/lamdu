...
{-# LANGUAGE NoImplicitPrelude, StandaloneDeriving, DeriveDataTypeable, FlexibleInstances, UndecidableInstances, TypeOperators, ConstraintKinds, GADTs #-}
...
type EqV v = Eq (v Sugar.EvalValues)
type NFDataV v = NFData (v Sugar.EvalValues)
...
deriving instance (Eq a, Eq n, Eq val) => Eq (Sugar.Payload val n Unit Unit a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.AnnotatedArg v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.AssignPlain v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.Assignment v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.Binder v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.Case v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.CaseArg v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.CaseKind v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.Composite v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.CompositeItem v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.CompositeTail v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.Definition v n Unit Unit a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.DefinitionBody v n Unit Unit a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.DefinitionExpression v n Unit Unit a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.Else v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.ElseIfContent v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.Fragment v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.Function v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.GetField v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.IfElse v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.Inject v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.InjectContent v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.LabeledApply v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.Lambda v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.Let v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.Nominal v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.Pane v n Unit Unit a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.PaneBody v n Unit Unit a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.Repl v n Unit Unit a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.Term v n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n, EqV v) => Eq (Sugar.WorkArea v n Unit Unit a)
deriving instance (Eq n, Eq v) => Eq (Sugar.FuncParam v n)
deriving instance (Eq n, EqV v) => Eq (Sugar.HoleResult v n Unit Unit)
...
instance (NFData a, NFData n, NFData val) => NFData (Sugar.Payload val n (T i) (T o) a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.AnnotatedArg v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.AssignPlain v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.Assignment v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.Binder v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.Case v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.CaseArg v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.CaseKind v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.Composite v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.CompositeItem v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.CompositeTail v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.Definition v n (T i) (T o) a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.DefinitionBody v n (T i) (T o) a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.DefinitionExpression v n (T i) (T o) a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.Else v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.ElseIfContent v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.Fragment v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.Function v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.GetField v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.IfElse v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.Inject v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.InjectContent v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.LabeledApply v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.Lambda v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.Let v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.Nominal v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.Pane v n (T i) (T o) a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.PaneBody v n (T i) (T o) a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.Repl v n (T i) (T o) a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.Term v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFDataV v) => NFData (Sugar.WorkArea v n (T i) (T o) a)
...
instance NFData (i (Sugar.ResVal n)) => NFData (Sugar.EvaluationScopes n i t) where
    rnf (Sugar.EvaluationScopes content) = rnf content
