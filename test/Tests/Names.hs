...
testWorkArea ::
    (Name -> IO b) ->
    Sugar.WorkArea (Sugar.EvaluationScopes InternalName Identity) InternalName Identity
    Unit
    (Sugar.Payload
        (Sugar.EvaluationScopes InternalName Identity Sugar.EvalValues)
        InternalName Identity Unit a) ->
    IO ()
...
getNames ::
    Sugar.WorkArea (Sugar.EvaluationScopes name Identity) name Identity o
    (Sugar.Payload
        (Sugar.EvaluationScopes name Identity Sugar.EvalValues) name Identity o a) ->
    [name]
getNames workArea =
